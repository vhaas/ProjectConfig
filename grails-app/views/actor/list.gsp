			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="description" title="${message(code: 'actor.description.label', default: 'Description')}" />
				...
				<g:each in="${actorInstanceList}" status="i" var="actorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${actorInstance.id}">${fieldValue(bean: actorInstance, field: "description")}</g:link></td>
